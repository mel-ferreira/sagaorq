...
import static br.com.microservices.orchestrated.orchestratorservice.ETopics.*;
...
public class KafkaConfig {
    ...
    private String boostratServers;
    ...
    private Map<String, Object> consumerProps()
    {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, boostratServers);
    ...
    private Map<String, Object> producerProps()
    {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, boostratServers);
